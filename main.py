...
Original file is located at
    https://colab.research.google.com/drive/1kO8SSm1h17g2HHKAgY3KUgldw7UpdMKS
...
print("Hello, {name} {surname}, your age is {age}".format(name=name, surname=surname, age=age))
...
# Print the result
print("Is number1 devisible by number2? :", result)
...
if side1 + side2 > side3 or side1 + side3 > side2 or side2 + side3 > side1:
  is_possible = "True"
print("We can draw a triangle:", is_possible)
...
if operation == "+":
  ...
  if num2 == 0:
    result = "The devision by zero cannot be performed."
  else:
    result = num1 / num2
else:
    result = "Invalid operation"
